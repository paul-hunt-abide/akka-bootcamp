    ...
    public class FileValidationActor : UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            ...
            if (string.IsNullOrEmpty(msg))
            {
                ...
                _consoleWriterActor.Tell(new Messages.NullInputError("Input was blanl. Please try again.\n."));

                // tell sender to continue doing it's thing (whatever that may be,
            ...
            else
            {
                ...
                else
                {
                    ...
                    // tell sender to continue doing it's thing (whatever that
